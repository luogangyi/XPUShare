...
XP_STAB_LONG_SEC="${XP_STAB_LONG_SEC:-28800}"
XP_STAB_RELEASE_MAX_SEC="${XP_STAB_RELEASE_MAX_SEC:-28800}"
...
xp_case_begin() {
  ...
  if [ -d "$XPUSHARE_CASE_LOG_DIR" ]; then
    rm -rf "$XPUSHARE_CASE_LOG_DIR"
  fi
