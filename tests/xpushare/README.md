...
# NPU 默认改为小算子循环
export XP_NPU_W1_MATRIX_N='4096'
export XP_NPU_W1_ITERS='20'
export XP_NPU_W1_TARGET_BYTES='3888000000'
export XP_NPU_W2_MATRIX_N='4096'
export XP_NPU_W2_ITERS='120'
export XP_NPU_W2_TARGET_BYTES='2352000000'
export XP_NPU_W2_MATMUL_N='2048'
export XP_NPU_W2_MATMUL_ITERS='200'
export XP_NPU_W3_MATRIX_N='4096'
export XP_NPU_W3_TARGET_BYTES='1728000000'
export XP_NPU_W5_MATRIX_N='4096'
export XP_NPU_W5_TARGET_BYTES='2352000000'
...
export XP_FUNC_QUOTA_REPEATS_NPU='1'
export XP_FUNC_NPU_QUOTA_WORKLOAD='w7'
export XP_FUNC_CUDA_QUOTA_WORKLOAD='w2'
export XP_FUNC_NPU_QUOTA_MIN_RATIO_25='3.5'
export XP_FUNC_NPU_QUOTA_MIN_RATIO_50='1.7'
export XP_FUNC_NPU_QUOTA_MIN_RATIO_75='1.2'
export XP_FUNC_NPU_MIX_MIN_RATIO_30='2.8'
export XP_FUNC_NPU_MIX_MIN_RATIO_60='1.5'
export XP_FUNC_NPU_MIX_MIN_30_OVER_60='1.5'
